...
namespace MigrationTool {
    ...
    public class HostInstance : Component {
        ...
        public string RunningServer {
            get {
                return (string)_curObj["RunningServer"];
            }
        }
        ...
        public string UniqueId {
            get {
                return (string)_curObj["UniqueID"];
            }
        }
        ...
        public static IEnumerable<HostInstance> GetInstances(ManagementScope mgmtScope, string condition, String [] selectedProperties) {
            if (mgmtScope == null)
            {
                mgmtScope = _statMgmtScope ?? new ManagementScope {Path = {NamespacePath = "root\\MicrosoftBizTalkServer"}};
            }
            using (ManagementObjectSearcher objectSearcher = new ManagementObjectSearcher(mgmtScope, new SelectQuery("MSBTS_HostInstance", condition, selectedProperties)))
            {
